...
SELECT shipping_type, ROUND(AVG(purchase_amount), 2) AS 'Round of Amount'
FROM customer
...
# Q6. Which 5 products have the highest percantage of purchases with discounts applied?
